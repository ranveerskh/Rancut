...
- Automated tests: 37 passed with real FFmpeg export, including direct H.264 stream, single JPEG-frame and batched JPEG-frame input.
...
- The workflow artifact path is `release/RanCut-0.4.6-Setup.exe`.
