...
contextBridge.exposeInMainWorld('rancut',{
 ...
 assertUpdateAllowed:()=>ipcRenderer.invoke('update-allowed'),
 cancelUpdate:()=>ipcRenderer.invoke('cancel-update'),
 installUpdate:()=>ipcRenderer.invoke('install-update'),
 onUpdate:callback=>{const listener=(_,state)=>callback(state);ipcRenderer.on('update-progress',listener);return()=>ipcRenderer.removeListener('update-progress',listener);},
